...
Roberts_Decomp_filled = na.approx(ts.temp, na.rm = T, maxgap = 11)
...
# saving the plot as png 
ggsave("Roberts_SP_ARMAp1q2_boot.png", path = "results/graphs/")
...
# saving the plot as png 
ggsave("Roberts_CO_ARMAp1q2_boot.png", path = "results/graphs/")
...
# saving the plot as png 
ggsave("Gross_CO_ARMAp1q1_boot.png", path = "results/graphs/")
...
# saving the plot as png 
ggsave("Gross_SP_ARMAp1q1_boot.png", path = "results/graphs/")
...
#More autocorrelation. Going to use ARMAp3.
...
# saving the plot as png 
ggsave("Dillon_CO_ARMAp3_boot.png", path = "results/graphs/")
...
# saving the plot as png 
ggsave("Dillon_SP_ARMAp3_boot.png", path = "results/graphs/")
